...
def retail_mapper(frame, targ_col, retail_col_name):
    ...
    retailer_dict = {'34 Heritage':['34heritage'],
                     'ABC Pediatrics':['med.abc pediatrics ltd'],
                     ...
                     'Amazon':['amazon','amzn mktp', 'amazon.com','prime video channels',],
                     "Anderson's Bookstore":['andersons bksh'],
                     'Audi Financial':['audi fincl'],
                     "Bev's":['calis dba bevs'],
                     'Big Apple Bagels':['big apple bagels'],
                     ...
                     'Coursera':['coursra.lzz.bfg.xpi','coursra',],
                     ...
                     'Not Applicable':['amex epayment *ach','payment to chase card','payment thank you',
                            ...
                            'wellmore holding direct', 'late fee','payment thank you',],
                     ...
                     'Walmart':['walmart.com','wal-mart'],
                     'Whole Foods Market':['wholefds'],
                     'Windy Acres Farm':['windy acres farm'],
                    }
